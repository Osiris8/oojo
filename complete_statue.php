...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>Oodjo - App Landing Page Template</title>
    <!-- Favicon-->
    ...
    <div class="register-area d-flex">
      <div class="register-content-wrapper d-flex align-items-center">
        <div class="register-content">
          ...
          <a class="btn apland-btn" href="register.html"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</a>&nbsp;&nbsp;<h5>Completer votre profil</h5>
          <p>Merci de remplir les informations complémentaires pour completer votre profil</p>
          <!-- Form-->
          <div class="register-form">
            <form action="#" method="post">
              
                <div class="form-group"><i class="lni-user"></i>
                <input class="form-control" type="text" placeholder="Papa">
              </div><div class="form-group"><i class="lni lni-phone"></i>
                <input class="form-control" type="text" placeholder="Contact">
              </div><hr>
                <div class="form-group"><i class="lni-user"></i>
                <input class="form-control" type="text" placeholder="Maman">
              </div><div class="form-group"><i class="lni lni-phone"></i>
                <input class="form-control" type="text" placeholder="Contact">
              </div>
              ...
              <div class="custom-control custom-checkbox mb-3 mr-sm-2">
                ...
                <a href="complete2_statue.html" class="btn apland-btn w-100">Completer votre profil</a>
            </form>
          </div>
