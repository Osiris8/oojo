...
//////////////////////////////////////// profil image ////////////////////////////////////////////////////////
           ...
           $q1->execute([ 
            ...
            $q = $db->prepare("SELECT users_id FROM anglais WHERE users_id = :users_id");
            $q->execute([
           'id'=>$_SESSION['id']
           ...
           $q1 = $db->prepare('UPDATE anglais SET city = :city AND phone = :phone WHERE user_id = :user_id');
           $q1->execute([ 
...
<html lang="fr">
  ...
  <span class="sr-only">unread messages</span>
      ...
      <input type="number" class="form-control" id="colFormLabel">
          ...
          <button type="submit" class="btn btn-info btn-block" name="devoir">Enregistrer</button>
          </div>
          </div>
