...
//////////////////////////////////////// profil image ////////////////////////////////////////////////////////
           ...
           $q1->execute([ 
            ...
            $q = $db->prepare("SELECT users_id, classroom FROM anglais 
           ...
           'users_id'=>$_SESSION['id']
            ...
            if($user_id){
                ...
                $id = $user_id->users_id;
                $_SESSION['classroom'] = $user_id->classroom;

                
           $q1 = $db->prepare('UPDATE anglais SET 
           interrogation1_semestre1 = :interrogation1_semestre1,
            interrogation2_semestre1 = :interrogation2_semestre1, interrogation3_semestre1 = :interrogation3_semestre1, interrogation4_semestre1 = :interrogation4_semestre1, interrogation5_semestre1 = :interrogation5_semestre1,
            devoir1_semestre1 = :devoir1_semestre1, 
            devoir2_semestre1 = :devoir2_semestre1, 
            interrogation1_semestre2 = :interrogation1_semestre2, interrogation2_semestre2 = :interrogation2_semestre2, interrogation3_semestre2 = :interrogation3_semestre2, interrogation4_semestre2 = :interrogation4_semestre2, interrogation5_semestre2 = :interrogation5_semestre2,
            devoir1_semestre2 = :devoir1_semestre2,
            devoir2_semestre2 = :devoir2_semestre2 WHERE user_id = :user_id');
           $q1->execute([ 
           ...
           $q = $db->prepare('INSERT INTO anglais(user_id, classroom, interrogation1_semestre1,
           interrogation2_semestre1, interrogation3_semestre1, interrogation4_semestre1, interrogation5_semestre1,
           interrogation1_semestre2, interrogation2_semestre2, interrogation3_semestre2, interrogation4_semestre2, interrogation5_semestre2,
           devoir1_semestre1,
           devoir2_semestre1,
           devoir1_semestre2,
           devoir2_semestre2)
      
      VALUES(:user_id, :classroom, :interrogation1_semestre1,
           :interrogation2_semestre1, :interrogation3_semestre1, :interrogation4_semestre1, :interrogation5_semestre1,
           :devoir1_semestre1, :devoir2_semestre1,
           :interrogation1_semestre2, :interrogation2_semestre2, :interrogation3_semestre2, :interrogation4_semestre2, :interrogation5_semestre2,
           :devoir1_semestre2,
           :devoir2_semestre2)');
      $q->execute([
       'interrogation1_semestre1'=>'0',
       'interrogation2_semestre1'=>'0',
       'interrogation3_semestre1'=>'0',
       'interrogation4_semestre1'=>'0',
       'interrogation5_semestre1'=>'0',
       'devoir1_semestre1'=>'0',
       'devoir2_semestre1'=>'0',
       'interrogation1_semestre2'=>'0',
       'interrogation2_semestre2'=>'0',
       'interrogation3_semestre2'=>'0',
       'interrogation4_semestre2'=>'0',
       'interrogation5_semestre2'=>'0',
       'devoir1_semestre2'=>'0',
       'devoir2_semestre2'=>'0',
       'classroom'=>'0',
       'user_id'=>'0'
          ...
          <div class="row mt-5">
              ...
              <div class="col-lg-12 col-md-612 col-sm-12">
                  <div class="container">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h1 class="text-center">Votre note d'Anglais du 2nd Semestre</h1><br>
