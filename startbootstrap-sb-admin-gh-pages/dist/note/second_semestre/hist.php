...
<html lang="fr">
  ...
  <span class="sr-only">unread messages</span>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       <div class="row">
                            <div class="col-lg-6">
                        <h1 class="mt-4">Histoire Géoographie</h1>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Mes notes d'histoire Géoographie</li>
                        </ol>
          ...
          <div class="row mt-5">
              ...
              <div class="col-lg-12 col-md-612 col-sm-12">
                  <div class="container">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h1 class="text-center">Votre note d'histoire Géoographie du 2nd Semestre</h1><br>
                              
                              <p>Les progrssions sur votre note de d'histoire Géoographie s'afficheront ici</p>
        </div>
                          </div>
                      </div>
            ...
            <option selected>Mes interrogations</option>
            <option value="1">1ere interrogation</option>
            <option value="2">2eme Interrogation</option>
            <option value="3">3 eme Interrogation</option>
            </select>
              </div>
      ...
      <input type="number" class="form-control" id="colFormLabel">
          ...
          <button type="button" class="btn btn-info btn-block">Enregistrer</button>
          </div>
          </div>
          ...
          <div class="row"> 
              ...
              <h4> Devoir </h4>
              <select class="custom-select">
            <option selected>Mes devoirs</option>
            <option value="1">1er Devoir</option>
            <option value="2">2eme Devoir</option>
            </select>
              </div>
