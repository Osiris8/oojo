...
//////////////////////////////////////// profil image ////////////////////////////////////////////////////////
           ...
           $q1->execute([ 
            ...
            $q = $db->prepare("SELECT users_id, classroom FROM anglais2 
           ...
           $q = $db->prepare('INSERT INTO anglais2 (interrogation1_semestre1,
           interrogation2_semestre1, classroom, users_id)
      
VALUES(:interrogation1_semestre1, :interrogation2_semestre1, :users_id, :classroom)');
      $q->execute([
