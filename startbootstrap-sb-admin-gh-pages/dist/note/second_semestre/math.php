                    ...
                    <div class="container-fluid">
                       <div class="row">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Mes notes de mathématique</li>
                        </ol>
          ...
          <div class="row mt-5">
              ...
              <div class="col-lg-12 col-md-612 col-sm-12">
                  <div class="container">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h1 class="text-center">Votre note de mathématique du 2nd Semestre</h1><br>
                              
                              <p>Les progrssions sur votre note de mathématique s'afficheront ici</p>
        </div>
                          </div>
                      </div>
