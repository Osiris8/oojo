        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       <div class="row">
                            <div class="col-lg-6">
                        <h1 class="mt-4">Session du 23 Mars 2021</h1>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Etudiant : Marx Aledjo - Coaching Scolaire</li>
                        </ol>
          ...
          <div class="row mt-5">
              ...
              <div class="col-lg-12 col-md-612 col-sm-12">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h1 class="text-center">Point de la session passée</h1><br>
              ...
              <div class="col-lg-12 col-md-612 col-sm-12">
                      ...
                      <div class="card">
                          <div class="card-body">
                              <h1 class="text-center">Point de la session actuelle</h1><br>
                              
                              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo minus impedit, qui sed architecto doloremque? Facilis velit dolores quasi illo possimus qui cupiditate. Odio ad nesciunt error. Dolore, nam odio!</p>

                              <form method="post">
                              <div class="form-group">
                            <label for="exampleFormControlSelect1">Remplir le formulaire</label>
                            <textarea class="form-control" rows="5"></textarea>
                        </div>

                        <button class="btn btn-lg btn-info">Soumettre</button>
                              </form>
