...
<html lang="fr">
  ...
  <span class="sr-only">unread messages</span>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       <div class="row">
                            <div class="col-lg-6">
                        <h1 class="mt-4">Historique des sessions</h1>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Historique des sessions</li>
                        </ol>
        ...
        <h3 class="mt-2"> Historique de mes sessions </h3>
        ...
        <button type="button" class="btn btn-outline-info">A completer</button>
        <button type="button" class="btn btn-outline-info">Planifiés</button>
  ...
  <tbody>
    <tr>
      <th scope="row">23 Mars 2021</th>
      <td>Mark Offio</td>
      <td>Coaching Scolaire</td>
    </tr>
    <tr>
      <th scope="row">19 Février 2021</th>
      <td>Jacob Zouma</td>
      <td>Reussite Scolaire</td>
    </tr>
    <tr>
      <th scope="row">13 Janvier 2021</th>
      <td>Larry Outsun</td>
